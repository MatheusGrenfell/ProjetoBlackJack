...
namespace BlackJack
{
    ...
    {
        public Form_jogo(string nome1, string nome2)
        {
            InitializeComponent();
        ...
        public void resultado()
        {
            ...
            if (pontos_A > pontos_B && pontos_A <= 21)
                lblresultado.Text = lblnome1.Text + " GANHOU!!";
            else
                if (pontos_A < pontos_B && pontos_B <= 21)
                lblresultado.Text = lblnome2.Text + " GANHOU!!";
            else
                ...
                lblresultado.Text = "SEM VENCEDOR!";
        ...
        {
            Form voltar = new form_apresentacao();
            voltar.Show();
            this.Visible = false;
        }
    }
